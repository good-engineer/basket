...
public class Invoice {
    ...
    @org.jetbrains.annotations.Nullable
    @javax.persistence.JoinColumn(name = "order_id", nullable = false, foreignKey = @javax.persistence.ForeignKey(name = "fk_i_order_id"))
    ...
    @org.jetbrains.annotations.Nullable
    @javax.persistence.JoinColumn(name = "from_id", nullable = false, foreignKey = @javax.persistence.ForeignKey(name = "fk_from_user_id"))
    @javax.persistence.ManyToOne(fetch = javax.persistence.FetchType.EAGER)
    private com.maryland.basket.entity.User from;
    @org.jetbrains.annotations.Nullable
    @javax.persistence.JoinColumn(name = "to_id", nullable = false, foreignKey = @javax.persistence.ForeignKey(name = "fk_to_user_id"))
    @javax.persistence.ManyToOne(fetch = javax.persistence.FetchType.EAGER)
    ...
    com.maryland.basket.entity.OrderRecord order, @org.jetbrains.annotations.Nullable
